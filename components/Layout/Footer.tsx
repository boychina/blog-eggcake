    ...
    <footer className="bg-accent-1 border-t border-accent-2">
      <div className="container mx-auto px-5">
        ...
        <div className="text-sm mt-2 pb-8 text-gray-500 flex justify-center">
          ...
          <a target="_blank" rel="noreferrer" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=51010802001016" className="ml-2 flex">
            <img src="/assets/备案图标.png" className="w-4 h-4" alt="备案图标" />
