...
在 [上一篇](/posts/ai/14.AI%20技术演进与核心算法实战%20-%20第十四篇：重排序（Re-Rank）技术：Cross-Encoder 模型原理及其在提升检索精度中的关键作用) 中，我们探讨了 Cross-Encoder 重排序技术。但 RAG 系统的优化之路还未结束：**如何检索那些"只可意会不可言传"的内容？如何处理超长文档的上下文关系？如何让检索系统具备"层层深入"的能力？**
