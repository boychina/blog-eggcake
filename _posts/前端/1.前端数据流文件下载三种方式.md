...
coverImage: "/assets/posts/前端数据流文件下载三种方式/cover/downloading-frontend-data-stream-files.jpg"
author:
  name: 蛋烘糕
  picture: "/assets/posts/前端数据流文件下载三种方式/author/zhaohuan.jpg"
ogImage:
  url: "/assets/posts/前端数据流文件下载三种方式/cover/downloading-frontend-data-stream-files.jpg"
---
