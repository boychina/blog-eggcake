...
coverImage: "/assets/posts/React-diff-算法/cover/react-diff.png"
author:
  name: 蛋烘糕
  picture: "/assets/posts/React-diff-算法/author/zhaohuan.jpg"
ogImage:
  url: "/assets/posts/React-diff-算法/cover/react-diff.png"
---
...
![reactdiff1-300x167.png](/assets/posts/React-diff-算法/context/reactdiff1-300x167.png)

首先，进行同级比较，并非循环比较。这样比较次数就降为一层一次，时间复杂度直接降为 O(n)
如果同级相同位置节点不一样，则直接删除替换，简单粗暴。
而对于节点移动，同样道理，也是简单粗暴的删除重建。如下图所示（图中第四步应该是删除左侧的整棵 A 树）：

![treediff2-300x145.png](/assets/posts/React-diff-算法/context/treediff2-300x145.png)

## Component diff

不多说，先上图：

![comdiff1-300x124.png](/assets/posts/React-diff-算法/context/comdiff1-300x124.png)
...
![elediff-300x152.png](/assets/posts/React-diff-算法/context/elediff-300x152.png)
