...
coverImage: "/assets/posts/React-grid-layout-一个支持拖拽的栅格布局库/cover/react-grid-layout.gif"
author:
  name: 蛋烘糕
  picture: "/assets/posts/React-grid-layout-一个支持拖拽的栅格布局库/author/zhaohuan.jpg"
ogImage:
  url: "/assets/posts/React-grid-layout-一个支持拖拽的栅格布局库/cover/react-grid-layout.gif"
---
