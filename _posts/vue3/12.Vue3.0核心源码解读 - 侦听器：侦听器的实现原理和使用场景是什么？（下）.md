...
coverImage: "/assets/posts/Vue3.0核心源码解读-侦听器：侦听器的实现原理和使用场景是什么？（下）/cover/vue3-core-source-code-9.png"
author:
  name: 蛋烘糕
  picture: "/assets/posts/Vue3.0核心源码解读-侦听器：侦听器的实现原理和使用场景是什么？（下）/author/zhaohuan.jpg"
ogImage:
  url: "/assets/posts/Vue3.0核心源码解读-侦听器：侦听器的实现原理和使用场景是什么？（下）/cover/vue3-core-source-code-9.png"
---
