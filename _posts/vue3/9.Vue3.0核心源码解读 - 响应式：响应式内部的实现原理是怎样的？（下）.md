...
coverImage: "/assets/posts/Vue3.0核心源码解读-响应式：响应式内部的实现原理是怎样的？（下）/cover/vue3-core-source-code-6.png"
author:
  name: 蛋烘糕
  picture: "/assets/posts/Vue3.0核心源码解读-响应式：响应式内部的实现原理是怎样的？（下）/author/zhaohuan.jpg"
ogImage:
  url: "/assets/posts/Vue3.0核心源码解读-响应式：响应式内部的实现原理是怎样的？（下）/cover/vue3-core-source-code-6.png"
---
...
![CgqCHl8iOeqAJJlaAAHAhGDRoDQ714.png](/assets/posts/Vue3.0核心源码解读-响应式：响应式内部的实现原理是怎样的？（下）/context/CgqCHl8iOeqAJJlaAAHAhGDRoDQ714.png)
