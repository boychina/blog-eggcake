...
coverImage: "/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/cover/vue3-core-source-code-3.png"
author:
  name: 蛋烘糕
  picture: "/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/author/zhaohuan.jpg"
ogImage:
  url: "/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/cover/vue3-core-source-code-3.png"
---
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8QHwmAHuQrAAB7807ZTzY864.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxNCAbTueAABtqP8l5JI050.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxN6AMzbfAACPna55Fmk255.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxO2AffFhAACJ52ATnwQ480.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8OxQKAd7fjAACNTHXEkuQ335.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxQ-ADmRcAACCSIpni8Y429.png)

此时的结果：i 是 2，e1 是 4，e2 是 3。

接着从尾部同步节点：

![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxRqANXzyAACGFb9dacI061.png)

此时的结果：i 是 2，e1 是 2，e2 是 1，满足删除条件，因此删除子节点中的多余节点：

![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8OxSeAMW8gAACCvYcKESo055.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxT6AVycJAAClkNghf-k681.png)

我们还是从同步头部节点开始，用图的方式演示这一过程。

首先从头部同步节点：

![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8OxUyAaCXvAAC6Lv79hSs090.png)

同步头部节点后的结果：i 是 2，e1 是 7，e2 是 7。

接着从尾部同步节点：

![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxVeAYV_ZAADCIt6XIHI609.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8OxWOAKRnGAAAzjDtkQJI201.png)

如果选择了 [1, 2, 4, 5] 作为递增子序列，那么在倒序遍历的过程中，遇到 5、4、2、1 不动，遇到 6、3 移动即可，如下图所示：

![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8OxW6APB5gAAAshOjdgMY518.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8OxciAQJ6GAADhf7zD47s944.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/CgqCHl8OxdeAVdPEAAEh9JAOZ_E654.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxeiAIp0WAAFBcsdATCI981.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/600cf67a09683_600cf67b344c9.gif)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OxgOALDcQAABERFRRNqo370.png)
...
![image.png](/assets/posts/Vue3.0核心源码解读-组件更新：完整的Dom-diff流程（下）/context/Ciqc1F8OyzuASuJ7AAHSjr5SVlc999.png)
