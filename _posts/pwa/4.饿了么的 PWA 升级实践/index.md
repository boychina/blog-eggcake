...
coverImage: "/assets/posts/饿了么的-PWA-升级实践/cover/upgrading-eleme-to-pwa.jpg"
author:
  name: Hux
  picture: "/assets/posts/饿了么的-PWA-升级实践/author/hux.jpg"
ogImage:
  url: "/assets/posts/饿了么的-PWA-升级实践/cover/upgrading-eleme-to-pwa.jpg"
---
...
![](/assets/posts/饿了么的-PWA-升级实践/context/PUSH-link-rel-preload.jpg)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/PRECACHE-future-routes.jpg)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/Lighthouse-before.png)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/before-skeleton.jpg)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/msite-Before-Optim.png)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/after-skeleton.jpg)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/thisTick-%26-Load.png)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/nextTick-%26-Load.png)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/msite-After-Optim.png)
...
![](/assets/posts/饿了么的-PWA-升级实践/context/Lighthouse-after.png)

最后附上一张图，这张图当时是做给 Addy Osmani 的 I/O 演讲用的，描述了饿了么 PWA 是如何结合 Vue 来实现多页应用的 PRPL 模式，可以作为一个架构的参考与示意图。

![](/assets/posts/饿了么的-PWA-升级实践/context/Architecture.png)
